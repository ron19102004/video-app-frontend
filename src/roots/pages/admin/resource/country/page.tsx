...
export default function CountryAdminPage() {
  ...
  function handleAddCountry(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    ...
    setTimeout(() => {
      ...
      // giả lập thêm thành công/ thất bại
      if (Math.random() > 0.5) {
        setShowAddModal(false);
        setFormError(null);
      } else {
        setFormError("Có lỗi xảy ra khi thêm");
      }
    }, 1000);
  }

  function handleEditCountry(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
  ...
  return (
    <div className="w-full bg-bg-color min-h-[calc(100svh-64px)]">
      <div className="w-full lg:w-[1024px] mx-auto py-10 px-2 lg:px-0 overflow-auto">
        <div className="flex flex-col sm:flex-row items-start justify-between">
          <h2 className="font-bold text-lg">Country Management</h2>
          <button
        ...
        >
          {showAddModal ? (
            <div className="rounded-md bg-bg-color p-2">
              ...
              <form className="mt-4 w-72" onSubmit={handleAddCountry}>
                <input
                  name="countryName"
                  type="text"
                  placeholder="Tên"
            ...
            <div className="rounded-md bg-bg-color p-2">
              ...
              <form className="mt-4 w-72" onSubmit={handleEditCountry}>
                <input
                  name="countryName"
                  type="text"
                  placeholder="Tên mới"
